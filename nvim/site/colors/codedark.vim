...
let s:cdStatusBg = {'gui': '#2424f1', 'cterm': s:cterm05, 'cterm256': '188'}
let s:cdStatusFg = {'gui': '#f3ee2a', 'cterm': s:cterm05, 'cterm256': '188'}
...
call <sid>hi('StatusLine', s:cdFront, s:cdStatusBg, 'none', {})
call <sid>hi('StatusLineNC', s:cdFront, s:cdStatusBg, 'none', {})
