...
(custom-theme-set-faces
 ...
 '(default ((t (:background "#292c3e" :foreground "white"))))
 ...
 '(font-lock-string-face ((t (:background "#292c3e" :foreground "LightSalmon"))))
 '(font-lock-comment-face ((t (:foreground "Salmon"))))
 '(font-lock-type-face ((t (:foreground "PaleGreen"))))
 '(font-lock-variable-name-face ((t (:foreground "LightGoldenrod"))))
 '(font-lock-warning-face ((t (:bold t :foreground "Pink" :weight bold))))
 '(font-lock-doc-face ((t (:background: "#292c3e" :foreground "LightSalmon"))))
 ...
 '(header-line ((t (:inherit mode-line :background "#292c3e" :weight bold))))
